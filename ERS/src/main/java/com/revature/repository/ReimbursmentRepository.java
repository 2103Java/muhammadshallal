...
public interface ReimbursmentRepository {
	...
	public List<Reimbursment> selectByType(String type); //NIY // service for financial managers only
	public List<Reimbursment> selectByStatus(String status); //NIY // service for financial managers only
